...
private:
    ...
    string name;
    string color;
    string names[15] = {"Billy", "Gruff", "Nanny", "Dolly", "Bleat", "Gizmo", "Whiskers", "Snickers", "Bubbles", "Shadow", "Blaze", "Sunny", "Muffin", "Twilight", "Zippy"};
    string colors[15] = {"White", "Black", "Brown", "Grey", "Spotted", "Gold", "Silver", "Red", "Yellow", "Green", "Blue", "Mauve", "Orange", "Pink", "Purple"};

public:
    // Default constructor
    Goat() {
        age = rand() % 20 + 1;  // random age 1-20
